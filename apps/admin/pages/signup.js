                ...
                <Grid item>
                    <form noValidate onSubmit={formik.handleSubmit}>
                        <Grid container justify={"center"}>
                            <Grid item xs={12}>
                                <Grid container direction="column" alignItems="center" className={classes.resetCenterHeight}>
                                    <Grid item>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    label="Name"
                                    size="small"
                                    margin={(formik.touched.name && formik.errors.name ? true : false) ? "dense" : "normal"}
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    size="small"
                                    margin={
                                        (formik.touched.passwordConfirm && formik.errors.passwordConfirm ? true : false)
                                            ? "dense"
                                            : "normal"
                                    }
                                    autoComplete="current-password"
                            ...
                            <RadioGroup aria-label="position" name="position" value={formik.values.position} onChange={formik.handleChange}>
