...
import { Typography, Radio, RadioGroup, Button, FormControlLabel, Grid, Box, FormControl, FormLabel, IconButton} from "@material-ui/core";
        ...
        <Grid item xs={12} md={4}>
          <Grid item xs={12}>
            <Box mb={2} textAlign="center">
              <Typography variant="h4">{props.translate("signupAnswerbook")}</Typography>
              <Typography variant="subtitle1">{props.translate("signupMakeAccount")}</Typography>
          ...
          <Grid item xs={12}>
            <Box mt={2} textAlign="center">
              <Typography variant="body1">
                Already have an account ? <LinkComponent href="/">login</LinkComponent>
              </Typography>
            </Box>
          </Grid>
        </Grid>
